...
1. 修改文件 `include/unistd.h` ，新增全局函数
...
1. 修改 `linux-0.11/kernel/Makefile`，添加 `sem.c` 编译规则
...
1. 实现生产者程序 `producer.c` 和 消费者程序 `consumer.c`
...
1. 在linux0.11的Bochs中编译运行生产者-消费者程序
...
1. 在Ubuntu中挂载`hdc`，将linux0.11输出的文件移动到Ubuntu中
